...
from fakes import FakeGenerator, InMemoryDatabase, ScriptedEmbedder
from mini_rag.ask import ask_question, build_ask_response, main
from mini_rag.generation import REFUSAL_ANSWER, GenerationResult
from mini_rag.models import ChunkRecord, RetrievedChunk, make_chunk_id
...
def test_pgvector_retrieves_meals_for_food_question() -> None:
    ...
    from mini_rag.embeddings import SentenceTransformerEmbedder
